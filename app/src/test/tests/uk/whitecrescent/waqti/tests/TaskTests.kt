...
//    //region Label
//
//    @DisplayName("Task labels Property")
//    @Test
//    fun testTaskLabelProperty() {
//        // Initial Task labels Property values
//        val task = Task("My Task")
//        Assertions.assertFalse(task.labels is Constraint)
//        Assertions.assertEquals(DEFAULT_LABEL_LIST, task.labels.value)
//        Assertions.assertFalse(task.labels.isVisible)
//
//        // Change labels Property and check it is visible and still not a Constraint
//        task.setLabelProperty(Property(SHOWING, Label.createNewLabel("Label1")))
//        Assertions.assertFalse(task.labels is Constraint)
//        Assertions.assertEquals(Label.getLabelByName("Label1"), task.labels.value)
//        Assertions.assertTrue(task.labels.isVisible)
//
//        // Hide labels and check that it resets to default values
//        task.hideLabel()
//        Assertions.assertFalse(task.labels is Constraint)
//        Assertions.assertEquals(DEFAULT_LABEL_LIST, task.labels.value)
//        Assertions.assertFalse(task.labels.isVisible)
//    }
//
//    @DisplayName("Task labels Constraint")
//    @Test
...
//        Assertions.assertFalse(task.labels.isVisible)
//
//        // Change labels Property to a Constraint and check it matches default Constraint values
//        task.setLabelConstraint(task.labels.toConstraint())
//        Assertions.assertEquals(DEFAULT_LABEL_LIST, task.labels.value)
//        Assertions.assertFalse(task.labels.isVisible)
//        Assertions.assertFalse((task.labels as Constraint).isMet)
//
//        // Change labels Constraint to some values and check
//        task.setLabelConstraint(Constraint(SHOWING, Label.createNewLabel("Label1"), MET))
//        Assertions.assertEquals(Label.getLabelByName("Label1"), task.labels.value)
//        Assertions.assertTrue(task.labels.isVisible)
//        Assertions.assertTrue((task.labels as Constraint).isMet)
//
//        // Try to labels time when it is a Constraint
//        Assertions.assertThrows(IllegalStateException::class.java, { task.hideLabel() })
//        Assertions.assertTrue(task.labels is Constraint)
//    }
//
//    //endregion
//
